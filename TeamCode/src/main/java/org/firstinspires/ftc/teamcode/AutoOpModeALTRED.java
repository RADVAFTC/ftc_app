 ...
 */
@Autonomous(name = "AutoOp Mode ALT", group = "Autonomous") // Add this for default (Change name)

public class AutoOpModeALTRED extends LinearOpMode // Add this for default (Change AutoOpMode to match filename/classname)
{
