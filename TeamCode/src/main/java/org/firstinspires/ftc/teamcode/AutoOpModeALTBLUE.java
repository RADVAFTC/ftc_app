 ...
 */
@Autonomous(name = "AutoOp Mode ALT BLUE", group = "Autonomous") // Add this for default (Change name)

public class AutoOpModeALTBLUE extends LinearOpMode // Add this for default (Change AutoOpMode to match filename/classname)
{
    ...
    double[] motorLeftStepsTicks =  {23};
    double[] motorRightStepsTicks = {23};

    double[] leftmotorStepsSpeed = {1};
    double[] rightmotorStepsSpeed ={1};

    double[] motorLeftStepsTicks2 =  {-26};
    double[] motorRightStepsTicks2 = {-26};
