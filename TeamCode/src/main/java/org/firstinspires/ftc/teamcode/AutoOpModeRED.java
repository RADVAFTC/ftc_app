 ...
 */
@Autonomous(name = "AutoOp Mode RED", group = "Autonomous") // Add this for default (Change name)

public class AutoOpModeRED extends LinearOpMode // Add this for default (Change AutoOpMode to match filename/classname)
{
    ...
    double[] motorRightStepsTicks = {32};

    double[] leftmotorStepsSpeed = {1};
    double[] rightmotorStepsSpeed ={1};

    double[] motorLeftStepsTicks2 =  {30, 9};
    double[] motorRightStepsTicks2 = {30, 0};
